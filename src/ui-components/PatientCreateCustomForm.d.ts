...
export declare type PatientCreateCustomFormInputValues = {
    date?: string;
    last_name?: string;
    first_name?: string;
...
export declare type PatientCreateCustomFormValidationValues = {
...
export declare type PatientCreateCustomFormOverridesProps = {
    PatientCreateCustomFormGrid?: PrimitiveOverrideProps<GridProps>;
    ...
    veteran?: PrimitiveOverrideProps<SelectFieldProps>;
...
export declare type PatientCreateCustomFormProps = React.PropsWithChildren<{
    overrides?: PatientCreateCustomFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: PatientCreateCustomFormInputValues) => PatientCreateCustomFormInputValues;
    onSuccess?: (fields: PatientCreateCustomFormInputValues) => void;
    onError?: (fields: PatientCreateCustomFormInputValues, errorMessage: string) => void;
    onChange?: (fields: PatientCreateCustomFormInputValues) => PatientCreateCustomFormInputValues;
    onValidate?: PatientCreateCustomFormValidationValues;
} & React.CSSProperties>;
export default function PatientCreateCustomForm(props: PatientCreateCustomFormProps): React.ReactElement;
